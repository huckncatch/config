...
# One application per line, comments start with #
# Inline comments are supported: app-name # comment

# Manual downloads (not in this list)
...
hazel # automated file organization and cleanup using rules; https://www.noodlesoft.com/
moom # window management via snap zones, grids, and keyboard shortcuts; https://manytricks.com/moom/
...
fission # lossless audio editor for MP3, AAC, FLAC and more (no re-encoding); https://rogueamoeba.com/fission/
handbrake-app # open-source video transcoder supporting H.264, H.265, AV1, and more; https://github.com/HandBrake/HandBrake
iina # modern macOS-native media player built on mpv; https://github.com/iina/iina
piezo # simple drag-and-drop audio recorder from app sources; https://rogueamoeba.com/piezo/
...
daisydisk # visual disk space analyzer with interactive sunburst chart; https://daisydiskapp.com/
eaglefiler # personal document archiving, research, and reference management; https://c-command.com/eaglefiler/
...
# logitech-options # Logitech peripheral settings manager (legacy, superseded by Options+); https://www.logitech.com/en-us/product/options
# mountain # manage and eject external volumes and drives from the menu bar; https://appgineers.de/mountain/ ## deprecated ?

# Backup & Sync
carbon-copy-cloner # disk cloning, bootable backups, and scheduled incremental backup tasks; https://bombich.com/
idrive # cloud backup with continuous file protection and versioning; https://www.idrive.com/
maestral # lightweight open-source Dropbox client for macOS (no Electron); https://github.com/samschott/maestral

# Finance & Productivity
cardhop # contacts manager with natural language entry and quick actions; https://flexibits.com/cardhop
fantastical # feature-rich calendar and task manager with natural language parsing; https://flexibits.com/fantastical
moneydance # personal finance manager with budgeting, investments, and bank sync; https://moneydance.com/
